	...
	<body>
			...
			<table class="table table-dark">
				<tbody>
					...
					if (count($scenes[$currentScene]->credits) > 0) {
						echo('<tr><td>');
						echo('<button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#sources" aria-expanded="false" aria-controls="sources" onclick="setTimeout(function() { window.scrollBy(0, 1000); }, 250);">Show credits</button>');
						echo('</td></tr>');
					}
					?>
				</tbody>
		...
		<div class="collapse" id="sources">
			<div class="card card-body">
				<h3>Credits and people who helped render</h3>
				<p>
				<?php
