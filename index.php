			...
			<table class="table table-dark">
				<tbody>
					...
					<tr>
						<td>
						<?php
							if (is_null($scenes[$currentScene]->hint)) {
								echo("Take a look around in 360&#176;.");
							} else {
								echo($scenes[$currentScene]->hint);
							}
						?>
						</td>
					</tr>
